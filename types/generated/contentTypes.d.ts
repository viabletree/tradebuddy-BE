...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    kyc: Attribute.Component<'kyc.kyc', true>;
    image: Attribute.Media;
    customer_id: Attribute.String & Attribute.Unique;
...
export interface ApiExploreExplore extends Schema.CollectionType {
  ...
  attributes: {
    ...
    explore_category: Attribute.Relation<
      'api::explore.explore',
      'manyToOne',
...
export interface ApiPaymentMethodPaymentMethod extends Schema.CollectionType {
  ...
  attributes: {
    last_digit: Attribute.String & Attribute.Required;
    method_id: Attribute.String & Attribute.Required;
    brand: Attribute.String & Attribute.Required;
    expiry_month: Attribute.String & Attribute.Required;
    expiry_year: Attribute.String & Attribute.Required;
